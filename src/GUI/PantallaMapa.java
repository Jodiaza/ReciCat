 ...
 * @author TOSHIBA
 */
public class PantallaMapa extends javax.swing.JPanel {
    ...
    public PantallaMapa() {
        initComponents();
        ImageIcon peligro = Pantalla.escalar(new ImageIcon("./src/img/peligro.png"
                ).getImage(), 25, 25);
        ImageIcon reciclar = Pantalla.escalar(new ImageIcon("./src/img/reciclar.png"
                ).getImage(), 25, 25);
        ImageIcon atras = Pantalla.escalar(new ImageIcon("./src/img/atras.png").
                getImage(), 40, 40);
        
        btnAtras.setIcon(atras);
        jLabel1.setIcon(peligro);
        jLabel2.setIcon(peligro);
        jLabel3.setIcon(reciclar);
        jLabel4.setIcon(peligro);
        jLabel5.setIcon(reciclar);
        jLabel6.setIcon(reciclar);
        jLabel7.setIcon(reciclar);
        jLabel8.setIcon(reciclar);
        jLabel9.setIcon(reciclar);
        jLabel10.setIcon(reciclar);
        jLabel11.setIcon(reciclar);
        jLabel12.setIcon(reciclar);
        jLabel13.setIcon(reciclar);
        jLabel14.setIcon(reciclar);
        jLabel15.setIcon(reciclar);
        jLabel16.setIcon(reciclar);
        jLabel17.setIcon(peligro);
    }
